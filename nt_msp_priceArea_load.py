# [AG-4] Issue: Create a new column NEXT_PRICE for price change audit integration. - Root cause: The price change audit schema and related data handling code do not include the NEXT_PRICE field, re
