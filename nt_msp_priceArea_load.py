# [AG-5] Issue: Remove NEXT_PRICE from price change audit integration - Root cause: The root cause is that the NEXT_PRICE field is still being included in the price change audit integr
